...
function Movies() {
 ...
 let{data}=await axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=d96e28fc086320e77dd0ef3f431bd5a6&language=en-US&page=${page}`);
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <h1 className='text-center mt-5 mb-5'>- Movies List 1 -</h1>
    ...
    <div className='row text-center mt-5'>
    <h1 className='text-center mt-5 mb-5'>- Movies List 2 -</h1>
    ...
    <div className='row text-center mt-5'>
    <h1 className='text-center mt-5 mb-5'>- Movies List 3 -</h1>
